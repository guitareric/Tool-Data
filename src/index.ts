...
tools.forEach(element => {
  const axiosConfig = {
    headers: {
      ...
      "authorization": "Bearer eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJ1c2VybmFtZSI6InUwNDgwNzg5IiwiaWF0IjoxNjYwMDY4NzkwLCJleHAiOjE2NjAxMTE5OTB9.YxdO3YcxllXDPup2LxAKh8msas58tQDaUUtipqwi5vA",
      ...
      "cookie": "_ga_52FB6H2PTN=GS1.1.1648575042.1.1.1648575073.0; _uetvid=09033fe0b53311ecae381148edeb6caa; _scid=861f50e7-3061-4076-88ee-b77710d5d23e; invoca_session=%7B%22ttl%22%3A%222022-05-05T22%3A52%3A14.204Z%22%2C%22session%22%3A%7B%7D%2C%22config%22%3A%7B%22ce%22%3Atrue%2C%22fv%22%3Atrue%7D%7D; _CEFT=Q%3D%3D%3D; tc_ptid=1JydAO1uzo3pltfycitwEn; tc_ptidexpiry=1712271134623; _sctr=1|1649138400000; _ce.s=v~0d96a58fa203ca3a15825de53c437de94e084710~vpv~0~v11.rlc~1649199135002; _ga_4359HTDVSF=GS1.1.1649199133.1.1.1649200108.0; _ga_242B9CL0LW=GS1.1.1650650512.3.1.1650652178.0; _hjSessionUser_2225490=eyJpZCI6ImZkYjNlMjY4LTY3MmMtNTg5Yy04MzgwLTQ4NjU3MmNjYzAxYSIsImNyZWF0ZWQiOjE2NDk4Njg3MzU3OTEsImV4aXN0aW5nIjp0cnVlfQ==; _gcl_au=1.1.999278872.1656444489; _ga_3K01Q5G281=GS1.1.1657745322.1.1.1657745846.0; _ga_QD3RQ85B8L=GS1.1.1658177360.4.0.1658177747.0; _ga_GF4RQ9XHSC=GS1.1.1658177360.4.0.1658177747.0; _fbp=fb.1.1658354722181.959174225; _hjSessionUser_2158953=eyJpZCI6IjhlODZlM2FiLTE0NTYtNWZlOC1iMDk5LWFiOTk2MjRhNDlmYSIsImNyZWF0ZWQiOjE2NTE2MDEyMTIyMTcsImV4aXN0aW5nIjp0cnVlfQ==; _ga_ZNFXH4D1WX=GS1.1.1659136412.1.1.1659136417.0; _ga_8DN5TEP3ML=GS1.1.1659136417.11.0.1659136418.0; _ga_YM5EY1JBTB=GS1.1.1659725523.15.0.1659725526.0; _ga=GA1.2.1010784119.1648571105; _gid=GA1.2.337954315.1659971364; _gat_gtag_UA_107113894_1=1",
...
const driveClientId = '612502561764-v9n85te8uhtkv62f4nsheopkv8rr6edr.apps.googleusercontent.com';
const driveClientSecret = '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';
const driveRedirectUri = 'https://developers.google.com/oauthplayground';
const driveRefreshToken = '1//04JmSmZZnCLh2CgYIARAAGAQSNwF-L9IrPFwM_Hma8kj0Zfg329SCZq4pGkzKcIoKZa6VOcjP93IBR9AxR8NziiWA6gCl4xPoMRg';

(async () => {
  console.log('waiting 5 seconds to let files finish saving')
  await new Promise(resolve => setTimeout(resolve, 5000));
  const googleDriveService = new GoogleDriveService(driveClientId, driveClientSecret, driveRedirectUri, driveRefreshToken);

  tools.forEach(async element =>{
    const finalPath = await path.resolve(__dirname, `../public/${element.name}.csv`);
    ...
    await googleDriveService.saveFile(`${element.name}`, finalPath, 'application/vnd.ms-excel', folder.id).catch((error) => {
      console.error(error);
    });
